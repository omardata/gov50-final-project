...
I am interested in exploring data related to which state-level attributes contribute to member-state voting patterns in international organizations. International relations is broadly my area of interest, and I am interested in looking there is higher or lower voting coincidence with the US, whether under either democratic or republican leadership.
...
My hypothesis is that under democratic presidents we will see an increase in voting alignment than under republican administrations.

The null hypothesis is that there is no significant difference between the measure of US-voting coincidence and the adminstration under which that coincidence is calculated.
