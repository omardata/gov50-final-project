...
International relations is broadly my area of interest. I am interested in exploring data related to which state-level attributes contribute to member-state voting patterns in international organizations. For this project I would like to look at when there is higher or lower voting coincidence with the US. 

The question is really this, what is the difference between voting  alignment with the US stances depending on other state characteristics. 

My hypothesis is that we can use aid as a measure. There are  

The null hypothesis is that there is no significant difference between the measure of US-voting coincidence and the amount of aid that a country receives. 

## 2 Data Section

I will use Eric Voeten's member-state votes in the United Nations General Assembly, and derived from it  by __ to arrive at ideal-point estimates of state preferences in the UN. I will explore differences between UNGA voting in the periods of ___. 
This data will be joined with data from AID, which gives data on bilateral aid commitments as reported by the donor governements. 

My variable of interest is the measure of US alignment in the UNGA. The varible that I am using can be calculated from the ideal point estimations that are given by ___. This is a measure of the difference between the USA ideal point and a country's ideal point, for a given session. In this given session there is 
