...
My first and primary analysis is simply of the provision of any aid counting as treatment. For this analysis I get a total of 
```{r}
...
## Getting just country data for one session 
ideal_treat|> 
  filter(session == 29)|>
