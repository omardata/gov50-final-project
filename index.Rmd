...
ideal_aid<- ideal_aid|> 
  mutate(ideal_two_before = IdealPointAll_plus_two,
         ideal_one_before = IdealPointAll_plus_one,
         ideal_duplicate = IdealPointAll,
         ideal_one_after = IdealPointAll_minus_one,
         ideal_two_after = IdealPointAll_minus_two)
```
