...
fit_treat_all <- lm (change_one_before ~ treatment_any + treat_some + treat_middle + treat_high, data = ideal_treat_fil)
...
## Conclusion
While this paper was unable to demostrate a statistically significant result there is a promise to this project, and there is already some evidence of a correlation between the provision of aid and the decrease in distance. One glaring opportunity for improviing this paper would be to identify and include data on possible confounders and to include this in a multi-variable regression. This might allow us to demonstrate that for the most 
