...
This is interesting, as a hypothesis because __.
...
Data for the my dependent variable is taken from Dreher et. all 2008, who provides a measure of state preference as calculated from United Nations General Assembly Voting Data. There is a sense in which there is a most   
...
will use Eric Voeten's member-state votes in the United Nations General Assembly, and derived from it  by __ to arrive at ideal-point estimates of state preferences in the UN. I will explore differences between UNGA voting in the periods of ___. 
